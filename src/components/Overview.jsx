...
export default function Overview({ setOpen }) {
  return (
    <section id="overview" className="relative overflow-hidden py-16 md:py-20 lg:py-24 bg-[#f8f5ed] w-full">
      ...
      {/* MATCHED GLOBAL CONTAINER: Standardizes the exact left alignment and side gaps */}
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 w-full relative z-10">
        ...
        <div className="grid md:grid-cols-[1.15fr_0.85fr] gap-8 md:gap-12 lg:gap-16 items-center w-full">
          
          {/* LEFT COLUMN: Starting points now perfectly match the upper sections */}
          <motion.div
          ...
          >
            ...
            <h2 
              className="text-[#111111] text-[36px] md:text-[48px] lg:text-[58px] leading-[1.15] tracking-[-1.5px] mb-4 font-medium" 
