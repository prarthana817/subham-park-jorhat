...
export default function Overview({ setOpen }) {
  return (
    <section id="overview" className="relative overflow-hidden py-16 lg:py-24 bg-[#f8f5ed]">
      ...
      {/* Set outer container to 1120px to prevent the layout from splitting apart */}
      <div className="relative z-10 max-w-[1120px] mx-auto px-5 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-[1.15fr_0.85fr] gap-10 lg:gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-[#111111] text-[34px] md:text-[42px] lg:text-[46px] leading-[1.08] tracking-[-1px] mb-4" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 500 }}>
              Elegant <span className="italic text-[#d1a54d]">Living</span> Crafted For Modern Homes
            </h2>

            <p className="text-[15px] leading-[1.65] text-[#5f6674] max-w-[580px] mb-6 text-left" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 400 }}>
            ...
            {/* FEATURES GRID */}
            <div className="grid sm:grid-cols-2 gap-3.5 max-w-[580px]">
              {/* CONFIGURATION */}
              <div className="bg-white rounded-[14px] border border-[#f0f0f0]/90 p-4 flex items-center gap-4 shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-all duration-300 hover:shadow-[0_6px_24px_rgba(0,0,0,0.04)]">
                ...
                <div>
                  <h4 className="text-[14px] text-[#171717] font-bold tracking-tight mb-[2px]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 600 }}>
                    Configuration
                  </h4>
                  <p className="text-[12.5px] text-[#707887]" style={{ fontFamily: "'Inter', sans-serif", fontWeight: 500 }}>
              ...
              <div className="bg-white rounded-[14px] border border-[#f0f0f0]/90 p-4 flex items-center gap-4 shadow-[0_4px_20px_rgba(0,0,0,0.02)] transition-all duration-300 hover:shadow-[0_6px_24px_rgba(0,0,0,0.04)]">
                ...
                <div>
                  ...
                  <p className="text-[12.5px] text-[#707887]" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          {/* RIGHT SIDE — CENTERED AND ALIGNED CLOSE TO INNER BOUNDS */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <div className="relative bg-[#fffdfa] rounded-[24px] border border-[#ede2d3] p-7 md:p-8 shadow-[0_15px_45px_rgba(0,0,0,0.04)] overflow-hidden">
              ...
              <p className="text-[19px] md:text-[21px] leading-[1.55] text-[#202020] italic mb-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontWeight: 400 }}>
                Creating elegant spaces that blend luxury, comfort and timeless living experiences for modern families.
              </p>

              <div className="flex items-center gap-3.5">
                <div className="w-[44px] h-[44px] rounded-full border border-[#d8bb82] bg-[#fbf4e6] flex items-center justify-center text-[#d1a54d] text-[16px]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700 }}>
                  S
                </div>
                <div>
                  <h4 className="text-[17px] text-[#171717] font-bold leading-tight mb-[2px]" style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
                    Subham Group
                  </h4>
                  <p className="text-[13px] text-[#727b88]" style={{ fontFamily: "'Inter', sans-serif" }}>
