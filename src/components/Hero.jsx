      ...
      <div className="relative z-10 max-w-[1380px] mx-auto w-full px-5 lg:px-6">
        <div className="grid lg:grid-cols-[0.92fr_1.08fr] items-center gap-10 lg:gap-8">
          ...
          >
            ...
            {/* HEADING */}
            <h1
              className="text-[#111111] text-[48px] md:text-[58px] lg:text-[70px] leading-[0.92] tracking-[-2px] mb-4"
              style={{
                fontFamily: "'Cormorant Garamond', serif",
                fontWeight: 500,
              }}
            >
              Elevate <span className="italic text-[#d1a54d]">Your</span>
              <br />
              Lifestyle
            </h1>
            ...
            {/* DESCRIPTION */}
            <p
              className="max-w-[720px] text-[16px] lg:text-[17px] leading-[1.72] tracking-[-0.01em] text-[#5f6674] mb-7 text-justify"
              style={{
                fontFamily: "'Inter', sans-serif",
                fontWeight: 400,
                wordSpacing: "-2px",
            ...
            >
              Experience premium residences surrounded by greenery and thoughtfully
              crafted architecture designed for elevated modern living in the heart of
              Jorhat.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <div className="relative px-5 py-[11px] rounded-[16px] border border-[#dcc89b] bg-[#e8d6ab] shadow-[0_8px_18px_rgba(209,165,77,0.08)] overflow-hidden">
                ...
                <div className="relative z-10 flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-[#e2cca0] flex items-center justify-center text-[#b78528] shadow-inner">
                    <MapPin size={15} />
                  </div>
                  <div>
                    <p
                      className="uppercase tracking-[0.18em] text-[8px] text-[#9e7426] mb-[2px]"
                      style={{
                        fontFamily: "'Inter', sans-serif",
                        fontWeight: 700,
                      }}
                    ...
                    <h4
                      className="text-[18px] md:text-[20px] leading-none text-[#111111]"
                      style={{
                        fontFamily: "'Cormorant Garamond', serif",
                        fontWeight: 700,
                      }}
              ...
              <div className="relative px-6 py-[11px] rounded-[16px] border border-[#dcc89b] bg-[#e8d6ab] shadow-[0_8px_18px_rgba(209,165,77,0.08)] overflow-hidden">
                ...
                <div className="relative z-10 min-w-[85px]">
                  ...
                  <div className="flex items-end gap-[3px]">
                    <span
                      className="text-[14px] leading-none text-[#9e7426] mb-[2px]"
                      style={{
                        fontFamily: "'Cormorant Garamond', serif",
                        fontWeight: 600,
                      }}
                    ...
                    <h3
                      className="text-[28px] md:text-[31px] leading-[0.85] tracking-[-0.5px] text-[#111111]"
                      style={{
                        fontFamily: "'Cormorant Garamond', serif",
                        fontWeight: 700,
                      }}
                    ...
                    <span
                      className="text-[10px] uppercase tracking-[0.1em] text-[#6d6758] mb-[3px] ml-1"
                      style={{
                        fontFamily: "'Inter', sans-serif",
                        fontWeight: 700,
                      }}
          ...
          >
            <div className="relative overflow-hidden rounded-[34px] h-[360px] md:h-[470px] lg:h-[560px] w-full shadow-[0_25px_80px_rgba(0,0,0,0.10)]">
              <img
                src={heroBg}
                alt="Subham Park"
                className="w-full h-full object-cover object-top scale-[1.02] transition-transform duration-700 hover:scale-[1.06]"
              />
