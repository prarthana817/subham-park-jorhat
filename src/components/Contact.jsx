...
export default function Contact() {
  return (
    <section id="contact" className="relative py-8 lg:py-12 bg-[#0d1b46]">
      ...
      <div className="relative z-10 max-w-[1380px] mx-auto px-4 lg:px-5">
        <div className="grid lg:grid-cols-2 rounded-[24px] overflow-hidden border border-[#d8c79d] bg-[#fcfaf5] shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
          ...
          {/* LEFT SIDE — TIGHT & COMPACT */}
          <div className="p-6 md:p-8 flex flex-col justify-between bg-[#fcfaf5] gap-4">
            <div>
              <p className="uppercase tracking-[0.25em] text-[10px] text-[#c9a14a] mb-2 font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>
                PREMIUM LIVING
              </p>
              <h2 className="text-[#111111] text-[36px] md:text-[46px] lg:text-[52px] leading-[1.02] tracking-[-1.5px] font-medium" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                <div>Your Dream</div>
                <div>Home </div>
                <div className="text-[#d1a54d]">Awaits You</div>
              </h2>
              <p className="mt-3 max-w-[460px] text-[14px] lg:text-[15px] leading-[1.5] tracking-[-0.01em] text-[#5f6674] line-clamp-2 font-normal" style={{ fontFamily: "'Inter', sans-serif" }}>
                Talk to our team today. We'll walk you through every detail: unit selection, pricing, site visits, and everything in between.
              </p>
            </div>

            {/* ADDRESS BOX */}
            <div className="rounded-[14px] border border-[#e7dccb] bg-[#f8f1e4] p-3.5 shadow-[0_6px_20px_rgba(0,0,0,0.02)] max-w-xs">
              <p className="text-[9px] uppercase tracking-[0.22em] text-[#c9a14a] mb-0.5 font-bold" style={{ fontFamily: "'Inter', sans-serif" }}>
                LOCATION
              </p>
          ...
          <div className="p-6 md:p-8 bg-[#f4eee0] border-t lg:border-t-0 lg:border-l border-[#e1d2b3]">
            <h3 className="text-[#111111] text-[28px] lg:text-[34px] leading-[0.95] mb-1 font-semibold" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
              <span className="text-[#d1a54d]">Book</span> Site Visit
            </h3>
            <p className="text-[14px] text-[#6d7482] mb-4 font-normal" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            <div className="space-y-3">
              <div className="grid md:grid-cols-2 gap-3">
                <div>
                  <label className="block mb-1 text-[10px] uppercase tracking-[0.12em] text-[#5f6674] font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>FULL NAME</label>
                ...
                <div>
                  <label className="block mb-1 text-[10px] uppercase tracking-[0.12em] text-[#5f6674] font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>PHONE NUMBER</label>
              ...
              <div>
                <label className="block mb-1 text-[10px] uppercase tracking-[0.12em] text-[#5f6674] font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>EMAIL ADDRESS</label>
              ...
              <div>
                <label className="block mb-1 text-[10px] uppercase tracking-[0.12em] text-[#5f6674] font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>PREFERRED UNIT TYPE</label>
              ...
              <p className="mt-2 text-center text-[11px] text-[#7b8390]" style={{ fontFamily: "'Inter', sans-serif" }}>
