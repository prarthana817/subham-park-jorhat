...
export default function Contact() {
  return (
    <section id="contact" className="relative py-16 lg:py-24 bg-[#0d1b46]">
      <div className="absolute inset-0 bg-[#0d1b46]" />
      
      {/* Outer wrapper controls the absolute max-width of the entire card structure */}
      <div className="relative z-10 max-w-[1024px] mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 rounded-[24px] overflow-hidden border border-[#d8c79d] bg-[#fcfaf5] shadow-[0_20px_60px_rgba(0,0,0,0.3)]">
          
          {/* LEFT SIDE — PADDED AND SNUG */}
          <div className="p-8 lg:p-12 flex flex-col justify-between bg-[#fcfaf5] gap-8">
            <div>
              <p className="uppercase tracking-[0.25em] text-[10px] text-[#c9a14a] mb-2 font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>
                PREMIUM LIVING
              </p>
              <h2 className="text-[#111111] text-[32px] md:text-[38px] lg:text-[42px] leading-[1.08] tracking-[-1.5px] font-medium" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
                <div>Your Dream</div>
                <div>Home </div>
                <div className="text-[#d1a54d]">Awaits You</div>
              </h2>
              <p className="mt-4 text-[14px] leading-[1.6] tracking-[-0.01em] text-[#5f6674] font-normal" style={{ fontFamily: "'Inter', sans-serif" }}>
          ...
          <div className="p-8 lg:p-12 bg-[#f4eee0] border-t md:border-t-0 md:border-l border-[#e1d2b3] flex flex-col justify-center">
